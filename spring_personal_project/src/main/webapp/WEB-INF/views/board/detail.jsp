	...
	<div class="container-md mt-3 mb-3 mx-auto border rounded">
		...
		<div class="row mb-3">
			...
			<div class="col-1 d-flex align-items-center border rounded py-3" id="likeArea">
				<div class="w-50 d-flex justify-content-center" id="likeIcon">
			...
			<div class="col-1 d-flex align-items-center border rounded py-3" id="dislikeArea">
				<div class="w-50 d-flex justify-content-center" id="dislikeIcon">
			...
			<sec:authorize access="isAuthenticated()">
				<div class="col-1 d-flex align-items-center btn border-0" id="bookmarkArea"></div>
				<div class="col-5"></div>
			</sec:authorize>
			<sec:authorize access="isAnonymous()">
				<div class="col-6"></div>
			...
			<div class="col-10"></div>
				<div class="col-2 d-flex justify-content-end">
					<div class="w-75 d-flex justify-content-end bg-light border rounded">
						...
						<c:if test="${pri.uvo.authList.stream().anyMatch(a -> a.auth.equals('ROLE_ADMIN')).get()
						|| pri.uvo.id eq bvo.id}">
							<a href="/board/modify?bno=${bvo.bno}&id=${id}">
