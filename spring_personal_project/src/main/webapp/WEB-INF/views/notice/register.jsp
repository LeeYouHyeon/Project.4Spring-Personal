...
<div class="my-5 p-0">
		...
		<div class="row mb-3">
			...
			<div class="col-2 d-flex align-items-center">
				...
				<div class="w-25 form-check m-0 p-0 d-flex justify-content-center">
					<input class="form-check-input" type="checkbox" value="" id="expDateBtn">
				</div>
			</div>
			<div class="col-2 d-flex align-items-center">
				<input type="date" id="expDate" disabled>
			</div>
		</div>
	...
	<script type="text/javascript" src="/resources/js/noticeRegister.js"></script>
</div>
